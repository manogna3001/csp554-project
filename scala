...
var df = sqlContext.read.format("com.databricks.spark.csv").option("header","false").option("parserLib","UNIVOCITY").load("/home/hadoop/business.csv")
...
df = sqlContext.read.format("com.databricks.spark.csv").option("header","false").option("parserLib", "UNIVOCITY").load("/home/hadoop/review.csv")
